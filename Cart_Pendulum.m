...
##*
##*  Team ID : eYRC#2724
##*  Team Leader Name: Pinaki Sen
##*  Team Member Name: Ayush Ranjan Singh, Dheeresh Kumar Chaturvedi, Amit Kumar
##*
##*  
...
function dy = cart_pendulum_dynamics(y, m, M, L, g, u)
  ...
  dy(1,1) = y(2);
  dy(2,1) = (1/a)*(-m^2*L^2*g*Cos*Sin - m*L^2*(m*L*y(4)^2*Sin)) + m*L*L*(1/a)*u;
  dy(3,1) = y(4);
  dy(4,1) = (1/a)*(-(m+M)*m*g*L*Sin + m*L*Cos*(m*L*y(4)^2*Sin)) - m*L*Cos*(1/a)*u;  
...
function [t,y] = lqr_cart_pendulum(m, M, L, g, y_setpoint, y0)
  [A, B] = cart_pendulum_AB_matrix(m , M, L, g);
  Q = [51 0 0 0; 0 53 0 0;0 0 58 0; 0 0 0 1];
  R = [1];
